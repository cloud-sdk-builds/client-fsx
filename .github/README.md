...
[`@aws-sdk/client-fsx`](https://www.npmjs.com/package/@aws-sdk/client-fsx/v/3.565.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fsx@3.565.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rja5jtJPen+b6K3kfAyHGkzAapesLNy4XnDS97wN013v5L69tUtcLfrPkO1ioetO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-fsx": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fsx@3.565.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-fsx@3.565.0/index.min.mjs": "sha384-Rja5jtJPen+b6K3kfAyHGkzAapesLNy4XnDS97wN013v5L69tUtcLfrPkO1ioetO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-fsx/blob/refs/tags/3.565.0/LICENSE
```
